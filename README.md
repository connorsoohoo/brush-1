...
See [docs/dig-port/dig-port-usage.md](docs/dig-port/dig-port-usage.md) for all flags, output formats, and verification tips, and [docs/dig-port/dig-port-plan.md](docs/dig-port/dig-port-plan.md) for the design.
